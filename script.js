...
const gameData = {
    ...
    todTruth: {
        mild: [
            ...
            "Hva er det mest flaut du har gjort foran en du var forelsket i?",
                    "Hvilken mat kunne du aldri hatt i huset ditt?",
                    "Hva er et øyeblikk du angrer på fra ungdomsskolen?",
                    "Hvilken rar vane har du når du er hjemme alene?",
            ...
            "Har du noen gang stjålet noe, uansett hvor lite det var?",
                    "Har du noen gang late som du var syk for å slippe noe?",
            ...
            "Hvis du kunne vært usynlig for en dag, hva ville du gjort?",
                    "Hvilket talent later du som du har for å imponere noen?",
            ...
            "Hva er din aller største 'guilty pleasure' på TV?",
                    "Hva er en hemmelig hobby du har?",
        ...
        spicy: [
            ...
            "Hvem i rommet har de mest irriterende vanene, og hva er de?",
                    "Har du noen gang vært forelsket i en venns partner?",
            ...
            "Nevn én ting du har gjort dritings, som du angrer dypt på i edru tilstand.",
                    "Hva er ditt mest risikable spontane kyss?",
    ...
    todDare: {
        mild: [
            ...
            "Spis en teskje med noe fra kjøleskapet som gruppen velger (ketchup, sennep, etc.).",
                    "Sitt i 30 sekunder og late som du er en statue.",
                    "Gå ut av rommet, kom inn igjen og gjør din mest dramatiske entré noensinne.",
            ...
            "Bjeff som en hund hver gang noen sier navnet ditt i de neste 3 rundene.",
                    "Fortell din beste pappavits. Hvis ingen ler, må du ta en trøste-nødt.",
        ...
        spicy: [
            ...
            "Send en SMS til din tredje mest nylige kontakt og skriv 'Jeg vet hva du gjorde'.",
                    "Send en flørtende beskjed til din crush—og vis gruppen reaksjonen.",
            ...
            "Les høyt de tre siste meldingene i din mest aktive gruppechat.",
                    "Send en DM til din tredje mest nylige kontakt og skriv 'Jeg vet hva du gjorde'—og vis svaret.",
    ...
    wyr: [
        ...
        { opt1: "Alltid bruke sko som er ett nummer for små", opt2: "Alltid bruke sokker som matcher ikke" },
        { opt1: "Aldri mer kunne spise søtsaker", opt2: "Aldri mer kunne drikke kaffe" },
        { opt1: "Alltid ha full batteri på telefonen", opt2: "Alltid ha perfekt internettforbindelse" },
        { opt1: "Kunne teleportere 1 gang i uken", opt2: "Kunne spole tilbake 1 minutt i livet ditt hver dag" }
    ],
    ...
    trivia: [
        ...
        { q: "Hva er verdens største hav?", a: "Stillehavet" },
        { q: "Hvem skrev 'Romeo og Julie'?", a: "William Shakespeare" },
        { q: "Hva er hovedstaden i Japan?", a: "Tokyo" },
        { q: "Hvor mange kontinenter finnes det?", a: "Syv" },
        { q: "Hva er formelen for vann?", a: "H2O" },
        { q: "Hvilket år landet mennesker først på månen?", a: "1969" },
        { q: "Hva heter verdens høyeste fjell?", a: "Mount Everest" },
        { q: "Hvilket dyr er kjent for å ha lang hals?", a: "Giraff" }
    ]
    ,
    partyChallenges: [
